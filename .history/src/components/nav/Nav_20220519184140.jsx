...
{navItems.map((navItem,index)=>(<li onClick={()=>{navigate(navItem.url); handleNav()}} className='my-5 hover:cursor p-3 capitalize transition-all hover:bg-gray-200 hover:text-black'>
 {navItem.item}
</li>))}
<li>
