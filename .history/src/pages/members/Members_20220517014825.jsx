  ...
  return (
    ...
    <header>
      ...
      <ul className='overflow-x-scroll'>
        <li className='flex justify-between'><span className='w-[18%] flex-1'>fullname</span><span className='w-[18%] flex-1'>gender</span><span className='w-[18%] flex-1'>phone</span> <span className='w-[18%] flex-1'>email</span> <span className='w-[18%] flex-1'>image</span> </li>
