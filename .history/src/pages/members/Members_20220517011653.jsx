    ...
    <header>
      ...
      {members&&members.data.map((member,index) => (
        <li className='flex ' key={index}>
          ...
          <span className='bg-black text-white flex-2'>{member.lastname}</span>
          <span className='bg-black text-white flex-2'>{member.firstname}</span>
          <span className='bg-black text-white flex-2'>{member.gender}</span>
          <span className='bg-black text-white flex-2'>{member.phone}</span>
          <span className='bg-black text-white flex-2'>{member.website}</span>
          <span className='bg-black text-white flex-2'>{member.email}</span>
          <span className='bg-black text-white flex-2'>{member.birthday}</span>
          </div>
