  ...
  return (
    ...
    <header>
      ...
      <ul className='overflow-x-scroll'>
        <li className='flex justify-between'><span className='text-center'>fullname</span><span className='text-center'>gender</span><span className='text-center'>phone</span> <span className='text-center'>email</span> <span className='text-center'>image</span> </li>
