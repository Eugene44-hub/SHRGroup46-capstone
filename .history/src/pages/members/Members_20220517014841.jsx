  ...
  return (
    ...
    <header>
      ...
      <ul className='overflow-x-scroll'>
        <li className='flex justify-between'><span className='w-[18%]'>fullname</span><span className='w-[18%]'>gender</span><span className='w-[18%]'>phone</span> <span className='w-[18%]'>email</span> <span className='w-[18%]'>image</span> </li>
