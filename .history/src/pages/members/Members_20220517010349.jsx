  ...
  return (
    ...
    <header>
      ...
      <ul className='overflow-x-scroll'>
        <li className='flex justify-between'><span className='w-[1%] text-center'>id</span><span className='w-[1%] text-center'>firstname</span><span className='w-[1%] text-center'>lastname</span><span className='w-[1%] text-center'>gender</span><span className='w-[1%] text-center'>phone</span> <span className='w-[1%] text-center'>website</span><span className='w-[1%] text-center'>email</span><span className='w-[20%] text-center'>birthday</span> </li>
      {members&&members.data.map((member,index) => (
        <li className='flex justify-between' key={index}>
          ...
          <span className='w-[20%] text-center'>{member.birthday}</span>
        </li>
      ))}
