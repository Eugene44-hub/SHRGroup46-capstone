    ...
    <header>
      ...
      {members&&members.data.map((member,index) => (
        <li className='flex ' key={index}>
          ...
          <span className='bg-black text-white w-[200px]'>{member.lastname}</span>
          <span className='bg-black text-white w-[200px]'>{member.firstname}</span>
          <span className='bg-black text-white w-[200px]'>{member.gender}</span>
          <span className='bg-black text-white w-[200px]'>{member.phone}</span>
          <span className='bg-black text-white w-[200px]'>{member.website}</span>
          <span className='bg-black text-white w-[200px]'>{member.email}</span>
