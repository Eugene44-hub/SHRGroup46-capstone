...
console.log(members);
  return (
    ...
    <header>
      ...
      <ul>
        <li className='flex justify-between'><span className='w-[100px]'>id</span><span className='w-[100px]'>firstname</span><span className='w-[100px]'>lastname</span><span className='w-[100px]'>gender</span><span className='w-[100px]'>phone</span> <span className='w-[100px]'>website</span><span className='w-[100px]'>email</span><span className='w-[100px]'>birthday</span> </li>
