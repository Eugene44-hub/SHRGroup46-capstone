  ...
  return (
    ...
    <header>
      ...
      <ul className='overflow-x-scroll'>
        <li className='flex justify-between'><span className='w-[1%] text-center'>id</span><span className='w-[1%] text-center'>firstname</span><span className='w-[1%] text-center'>lastname</span><span className='w-[1%] text-center'>gender</span><span className='w-[1%] text-center'>phone</span> <span className='w-[1%] text-center'>website</span><span className='w-[1%] text-center'>email</span><span className='w-[10%] text-center'>birthday</span> </li>
