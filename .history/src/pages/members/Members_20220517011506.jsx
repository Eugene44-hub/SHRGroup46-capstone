    ...
    <header>
      ...
      {members&&members.data.map((member,index) => (
        <li className='flex ' key={index}>
          ...
          <span className='bg-black text-white mx-3'>{member.lastname}</span>
          <span className='bg-black text-white mx-3'>{member.firstname}</span>
          <span className='bg-black text-white mx-3'>{member.gender}</span>
          <span className='bg-black text-white mx-3'>{member.phone}</span>
          <span className='bg-black text-white mx-3'>{member.website}</span>
          <span className='bg-black text-white mx-3'>{member.email}</span>
          <span className='bg-black text-white mx-3'>{member.birthday}</span>
          </div>
