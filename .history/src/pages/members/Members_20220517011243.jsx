    ...
    <header>
      ...
      {members&&members.data.map((member,index) => (
        <li className='flex ' key={index}>
          ...
          <span className='bg-black text-white'>{member.lastname}</span>
          <span className='bg-black text-white'>{member.firstname}</span>
          <span className='bg-black text-white'>{member.gender}</span>
          <span className='bg-black text-white'>{member.phone}</span>
          <span className='bg-black text-white'>{member.website}</span>
          <span className='bg-black text-white'>{member.email}</span>
          <span className='bg-black text-white'>{member.birthday}</span>
        </li>
      ))}
